...
def adv(post, parameters, persona):
    ...
    output = f"""
    Your job is to critique this {platform} post draft. Give helpful, real feedback, but ensure
...
certain things to make it more appealing to the algorithm. This includes word changes, emoji usage, 
